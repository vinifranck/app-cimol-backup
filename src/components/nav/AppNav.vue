        ...
        <v-list-item link>
          <v-list-item-content>
            <v-list-item-title class="text-h6">
              <v-list-text v-text="$store.state.userNome" />
            </v-list-item-title>
...
<script>
  export default {
    ...
    data: () => ({
      selectedItem: 0,
      items: [
        { text: 'Cursos', icon: 'mdi-school', method:'Cursos'},
        { text: 'Turmas', icon: 'mdi-star', method:'turmas'},
        { text: 'Alunos', icon: 'mdi-account-multiple' , method:'alunos'},
        { text: 'Armarios', icon: 'mdi-equal-box',  method:'armarios'},
        { text: 'Patrimonios', icon: 'mdi-check-circle',  method:'patrimonios'},
        { text: 'Biblioteca', icon: 'mdi-book',  method:'biblioteca'},
        { text: 'Horarios', icon: 'mdi-border-all',  method:'Horarios'},
        { text: 'Logout', icon: 'mdi-logout',  method:'Horarios'},
      ],
    }),
  }
</script>
